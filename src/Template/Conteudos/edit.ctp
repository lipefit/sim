        ...
        <div class="col-sm-16 col-md-16">
            <div class="card">
                <div class="card-header">
                    <h6 class="card-title"><?= __('Editar conteúdo') ?></h6>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-16 col-md-16">
                            <div class="form-group">
                                ...
                                <?= $this->Form->control('url', ['id' => 'url', 'label' => false, 'class' => 'form-control', 'Placeholder' => 'URL', 'value' => $revisao->url]); ?>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-16 col-md-16">
                            <div class="form-group">
                                ...
                                <?= $this->Form->control('description', ['label' => false, 'class' => 'form-control', 'type' => 'textarea', 'value' => $revisao->description]); ?>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-16 col-md-16">
                            <div class="form-group">
                                ...
                                <?= $this->Form->control('content', ['label' => false, 'class' => 'form-control tinymce', 'type' => 'textarea', 'value' => $revisao->content]); ?>
                            </div>
                        </div>
                    </div>
