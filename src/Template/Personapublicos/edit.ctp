...
<div class="container">
    <div class="row  align-items-center justify-content-between">
        <div class="col-11 col-sm-12 page-title">
            <h3><i class="fa fa-group"></i> <?= __('Persona do público alvo') ?></h3>
        </div>
        ...
        <div class="col-sm-16 col-md-16">
            <div class="card">
                <div class="card-header">
                    <h6 class="card-title"><?= __('Editar persona') ?></h6>
                </div>
                            ...
                            <div class="avatar-changing">
                                <select name="avatar" class="image-picker form-control">
                                    <?php for ($i = 1; $i <= 20; $i++) { ?>
                                        ...
                                        ?>
                                        <option data-img-src="<?php echo Router::url('/'); ?>avatar/<?= $c; ?>.jpg" value="<?= $i; ?>" <?= $selected; ?>><?= $i; ?></option>
                                    <?php } ?>
                                </select>
