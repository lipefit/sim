<div class="modal dark_bg fade" id="mensagem_social" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<script>
    $('#message-button').click(function () {
        ...
        console.log(message);
        $.get('/sociais/saveMessage?mensagem=' + message + '&social_id=<?= $social->id; ?>&profile_id=<?=$profile['id'];?>', function (data) {
            location.reload();
        });
    });
</script>