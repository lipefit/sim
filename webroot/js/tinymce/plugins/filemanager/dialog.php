...
if (isset($_POST['submit'])) {
    ...
    if (isset($_GET['subfolder']) && !empty($_GET['subfolder'])) {
        ...
        if (!file_exists($thumbs_path . $subdir))
                ...
                <?php }else { ?>
                                                    ...
                                                    <figcaption>
                                                        <a href="javascript:void('')"
                                                           class="erase-button"
                    <?php if ($delete_folder) { ?>onclick="if (confirm('<?php echo lang_Confirm_Folder_del; ?>')) {
                                            delete_folder('<?php echo $root . $cur_dir . $file; ?>', '<?php echo $thumbs_path . $subdir . $file; ?>'); $(this).parent().parent().parent().hide(200);
                                            return false;}"<?php } ?> title="<?php echo lang_Erase ?>">
                        ...
                        <?php } ?>
                                                ...
                                                <?php if ($delete_file) { ?>onclick=" if (confirm('<?php echo lang_Confirm_del; ?>')) {
                                                                                    delete_file('<?php echo $root . $cur_dir . $file; ?>', '<?php echo $thumbs_path . $subdir . $file; ?>');
                                                                                    $(this).parent().parent().parent().parent().hide(200); return false;
                                                                                }"<?php } ?> title="<?php echo lang_Erase ?>"><i class="icon-trash <?php if (!$delete_file) echo 'icon-white'; ?>"></i></a>
                                                            </form>
                                                        </figcaption>
                                                    </figure>
